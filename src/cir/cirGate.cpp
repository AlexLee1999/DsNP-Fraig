...
void CirGate::printfanin(int level, int called, int marked, bool inv) const
{
...
void CirGate::printfanout(int level, int called, int marked, bool inv) const
{
...
void CirGate::dfs(vector<CirGate *> &gatelist, int marked)
{
