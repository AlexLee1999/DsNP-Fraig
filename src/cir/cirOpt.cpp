...
void CirMgr::optimize()
{
  ...
  for (int i = 0; i < _dfslist.size(); i++)
  {
    if (_dfslist[i]->getType() == AIG_GATE)
    {
      ...
      {
        if (_dfslist[i]->fanin()[j] == 1 && !(bothinvert(_dfslist[i]->fanin()[0], _dfslist[i]->fanin()[1]) && (_dfslist[i]->fanin()[0] != _dfslist[i]->fanin()[1])))
        { //case A
          if (j == 1)
          {
        ...
        if (_dfslist[i]->fanin()[j] == 0 && !(bothinvert(_dfslist[i]->fanin()[0], _dfslist[i]->fanin()[1])) && (_dfslist[i]->fanin()[0] != _dfslist[i]->fanin()[1]))
        { //case B
      ...
      if (_dfslist[i]->getType() == AIG_GATE && _dfslist[i]->fanin().size() != 0 && _dfslist[i]->fanin()[0] == _dfslist[i]->fanin()[1])
      { //case C
